...
if __name__ == '__main__':
    ...
    # test on a simple mesh (enable embree if installed)
    mesh = trimesh.load('models/bun_zipper.ply')
    ...
    img = PIL.Image.fromarray(a).rotate(90)

    # show the resulting image
    img.save("output/depth.png")
    ...
    rendered.save("output/color.png")
